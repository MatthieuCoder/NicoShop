 ...
 */
final class Version20230602161707 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT NOT NULL, commandes_id INT DEFAULT NULL, date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, adresse_livraison VARCHAR(255) NOT NULL, code_postal_livraison INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE produit (id INT NOT NULL, code VARCHAR(25) NOT NULL, libelle VARCHAR(255) NOT NULL, prix DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, addresse VARCHAR(255) NOT NULL, code_postal INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE commande ADD CONSTRAINT FK_6EEAA67D8BF5C2E6 FOREIGN KEY (commandes_id) REFERENCES "user" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP CONSTRAINT FK_6EEAA67D8BF5C2E6');
